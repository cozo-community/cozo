...
pub(crate) fn parse_aggr(name: &str) -> Option<Aggregation> {
    Some(match name {
        "and" => AGGR_AND.clone(),
        "or" => AGGR_OR.clone(),
        "unique" => AGGR_UNIQUE.clone(),
        "group_count" => AGGR_GROUP_COUNT.clone(),
        "union" => AGGR_UNION.clone(),
        "intersection" => AGGR_INTERSECTION.clone(),
        "count" => AGGR_COUNT.clone(),
        "count_unique" => AGGR_COUNT_UNIQUE.clone(),
        "variance" => AGGR_VARIANCE.clone(),
        "std_dev" => AGGR_STD_DEV.clone(),
        "sum" => AGGR_SUM.clone(),
        "product" => AGGR_PRODUCT.clone(),
        "min" => AGGR_MIN.clone(),
        "max" => AGGR_MAX.clone(),
        "mean" => AGGR_MEAN.clone(),
        "choice" => AGGR_CHOICE.clone(),
        "collect" => AGGR_COLLECT.clone(),
        "shortest" => AGGR_SHORTEST.clone(),
        "min_cost" => AGGR_MIN_COST.clone(),
        "bit_and" => AGGR_BIT_AND.clone(),
        "bit_or" => AGGR_BIT_OR.clone(),
        "bit_xor" => AGGR_BIT_XOR.clone(),
        "latest_by" => AGGR_LATEST_BY.clone(),
        "smallest_by" => AGGR_SMALLEST_BY.clone(),
        "choice_rand" => AGGR_CHOICE_RAND.clone(),
        _ => return None,
    })
}
